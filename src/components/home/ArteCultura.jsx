...
import { culturalPlaces } from "../../data/arteCultura";
      ...
      <section className="py-24 bg-white overflow-hidden">
        ...
        <div className="relative pb-2">
                        ...
                        <>
                          ...
                          <div className="w-full px-4 mb-2">
                            <button
                              ...
                              className="w-full bg-secondary hover:bg-secondary/90 text-white py-2 sm:py-2.5 px-3 sm:px-4 rounded font-medium transition-all text-xs uppercase tracking-widest shadow-lg hover:shadow-xl"
                            >
                              {t("culture.btnDetails")}
                            </button>
                          </div>
                        </>
                      )}
          ...
          <div className="flex items-center justify-center gap-6 md:gap-8 mt-4 md:mt-8 pb-4 relative">
            <button className="culture-prev w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-secondary hover:bg-secondary hover:text-white text-secondary transition-all flex items-center justify-center bg-white shadow-lg">
              <span className="text-xl">←</span>
            </button>

            <div className="text-secondary font-medium text-base md:text-lg">
              {activeIndex + 1} / {culturalPlaces.length}
            </div>

            <button className="culture-next w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-secondary hover:bg-secondary hover:text-white text-secondary transition-all flex items-center justify-center bg-white shadow-lg">
              <span className="text-xl">→</span>
            </button>
          </div>
        </div>
